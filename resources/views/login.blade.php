...
<head>
	...
	<title>Phần mêm quản lí học phí sinh viên</title>
...
<body>
    <nav class="navbar navbar-transparent navbar-absolute">
        <div class="container">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="../dashboard/overview.html">Phần mềm quản lí học phí sinh viên</a>
            </div>
    ...
    <div class="wrapper wrapper-full-page">
        <div class="full-page login-page" data-color="" data-image="{{asset('assets')}}/img/background/background-3.jpg">
        <!--   you can change the color of the filter page using: data-color="blue | azure | green | orange | red | purple" -->
                                ...
                                <div class="card" data-background="color" data-color="blue">
                                    ...
                                    <div class="card-content">
                                        <div class="form-group">
                                            ...
                                            <input type="email" name="email" placeholder="Nhập email" class="form-control input-no-border" @if (Session::exists('error')) value="{{ Session::get('error.email') }}" @endif>
                                        </div>
                                        <div class="form-group">
        	...
        	<footer class="footer footer-transparent">
                <div class="container">
                    <div class="copyright">
                        &copy; <script>document.write(new Date().getFullYear())</script>, made with <i class="fa fa-heart heart"></i> by <a href="">Quốc Khánh , Đức Vượng</a>
                    </div>
                </div>
            </footer>
        </div>
